...
class tempmail:
    ...
    def createEmail(self):
        ...
        vmail = front+"@belgianairways.com"
...
class createAccount:
    ...
    def create(self, email):
        ...
        data = {
            ...
            "password": "malboloro@123",
            "password2": "malboloro@123",
            "email": email,
            "voucher_code": "",
            "captcha": "",
            "robert_status": "1",
        ...
        if 'session_auth_hash' in json.dumps(req):
            ...
            open("windscribe_account.txt", "a+").write(f"{app.username}|{imel}|malboloro@123\n")
...
try:
    ...
    # Visit the first URL before signing up
    first_url = "https://windscribe.com/yo/o6uzqmab"
    requests.get(first_url)
    ...
    cae = re.search(r'\[https://windscribe.com/signup/confirmemail/(.*?)\]', resp).group(1)
